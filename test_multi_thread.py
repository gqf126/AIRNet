...
for test_loader in test_loaders:
    ...
    for data in test_loader:
        ...
        # print("process time per img: {}, modle inference time: {}, img process time: {}, thread1: {}, thread2: {}".format((time.time()-time_start)/batch_size,
        #     model_inference_time/batch_size, img_process_time/batch_size, time_thread1, time_thread2))
