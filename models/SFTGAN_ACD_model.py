...
class SFTGAN_ACD_Model(BaseModel):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            if train_opt['cls_weight'] > 0:
                l_fea_type = train_opt['cls_criterion']
                if l_fea_type == 'BCE':
                    self.cri_ce = nn.BCEWithLogitsLoss().to(self.device)
            ...
            # optim_params_SFT = optim_params_other
    ...
    def feed_data(self, data, need_HR=True):
        ...
        # label
        self.var_label = data['seg_label'].to(self.device)
    ...
    def optimize_parameters(self, step):
        ...
        l_d_cls_real = self.cri_ce(cls_d_real, self.var_label)
        # fake data
        ...
        l_d_cls_fake = self.cri_ce(cls_d_fake, self.var_label)
